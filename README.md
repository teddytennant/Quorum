...
Quorum is a Zig-based inference engine focused on MoE models with expert offloading and Apple Silicon acceleration. The initial goal is to run GLM-4.7-Flash on an M3 MacBook Air with int4/int8 quantization and SSD-backed expert caching.
